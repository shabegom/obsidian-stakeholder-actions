...
export interface ActionTrackerSettings {
  personRegexpString: string, projectRegexpString: string,
      miscRegexpString: string, dateRegexpString: string,
      discussWithRegexpString: string, waitingForRegexpString: string,
      promisedToRegexpString: string, somedayMaybeRegexpString: string,
      isInboxVisible: boolean, isAgingVisible: boolean, isTodayVisible: boolean,
      isScheduledVisible: boolean, isStakeholderVisible: boolean,
      isSomedayVisible: boolean, inboxTooltip: string, agingTooltip: string,
      todayTooltip: string, scheduledTooltip: string,
      stakeholderTooltip: string, somedayTooltip: string,
}
...
export const DEFAULT_SETTINGS: ActionTrackerSettings = {
  ...
  stakeholderTooltip :
      'Stakeholder and Project actions: discussWith, promisedTo, waitingFor. Only items that have a valid project or person will show up here. Stakeholder actions without project or person are in the Inbox.',
...
export class ActionTrackerSettingTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    this.containerEl.createEl('p', {
      text :
          'Selectors are regular expressions that capture specific part of an action. ' +
    ...
    this.containerEl.createEl('p', {
      text :
          'Use these selectors to capture specific information from your action item. ' +
    ...
    this.containerEl.createEl('p', {
      text :
          'Catherine will be identified as the Action Party and "Secret campaign" as the Project.'
    });
    new Setting(containerEl)
        ...
        .addText(text => text.setPlaceholder('\\[{2}People\\/(.*?)\\]{2}')
    ...
    new Setting(containerEl)
        ...
        .addText(text => text.setPlaceholder('\\[{2}Projects\\/(.*?)\\]{2}')
    ...
    new Setting(containerEl)
        ...
        .setDesc(
            'This is the regular expression to capture whatever other part of the action you prefer to capture. ' +
    ...
    this.containerEl.createEl('p', {
      text :
          'This is the actions\'s due date. If set, your action will show up in one of the date filtered views: ' +
              'Aging (date is overdue), Today (date is today), Scheduled (future date).'
    });
    new Setting(containerEl)
        .setName('Date')
        .setDesc(
            'This is the regular expression to get the date for an action. You have two options. 1) If your RegExp captures 3 values, then ' +
        ...
        .addText(text => text.setPlaceholder('#(\\d{4})\\/(\\d{2})\\/(\\d{2})')
    ...
    this.containerEl.createEl('p', {
      text :
          'These three tags allow you to qualify the type of stakeholder action you intend to take. ' +
    ...
    new Setting(containerEl)
        ...
        .setDesc(
            'This is the regular expression to identify topics you want to discuss with someone.')
        .addText(text =>
                     text.setPlaceholder('#(discussWith)')
    ...
    new Setting(containerEl)
        .setName('Waiting For')
        .setDesc(
            'This is the regular expression to identify actions which you are waiting for some to complete.')
        .addText(text =>
                     text.setPlaceholder('#(waitingFor)')
    ...
    new Setting(containerEl)
        ...
        .addText(text =>
                     text.setPlaceholder('#(promisedTo)')
    ...
    this.containerEl.createEl('p', {
      text :
          'Use this tag to mark actions that are deliberately without a deadline, such as ' +
    ...
    new Setting(containerEl)
        ...
        .setDesc(
            'This is the regular expression to identify the Someday/Maybe tag.')
        .addText(
            text => text.setPlaceholder('#(someday)')
    ...
    new Setting(containerEl)
        ...
        .addToggle(value => value.setValue(this.plugin.settings.isInboxVisible)
                                .onChange(async (value) => {
    ...
    new Setting(containerEl)
        ...
        .addToggle(value => value.setValue(this.plugin.settings.isAgingVisible)
                                .onChange(async (value) => {
                                  this.plugin.settings.isAgingVisible = value;
                                  await this.plugin.saveViewDisplaySettings();
                                }));
    new Setting(containerEl).setName('Aging tooltip').addTextArea(text => {
    ...
    new Setting(containerEl)
        ...
        .addToggle(value => value.setValue(this.plugin.settings.isTodayVisible)
                                .onChange(async (value) => {
    ...
    new Setting(containerEl)
        ...
        .addToggle(value =>
                       value.setValue(this.plugin.settings.isScheduledVisible)
                           .onChange(async (value) => {
    ...
    new Setting(containerEl)
        ...
        .addToggle(value =>
                       value.setValue(this.plugin.settings.isStakeholderVisible)
                           .onChange(async (value) => {
    ...
    new Setting(containerEl)
        ...
        .addToggle(value =>
                       value.setValue(this.plugin.settings.isSomedayVisible)
                           .onChange(async (value) => {
